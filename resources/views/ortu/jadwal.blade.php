...
<div class="space-y-10">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
            ...
            <p class="text-sm text-white/50 mt-1">
                Jadwal sesi latihan rutin dan khusus untuk kelompok kelas anak Anda.
            </p>
        </div>
    ...
    @else
        ...
        <div class="text-center py-20 border border-dashed border-white/10 rounded-[32px] bg-white/[0.01]">
            <i data-lucide="calendar-x" class="w-16 h-16 text-white/20 mx-auto mb-4"></i>
            <h3 class="heading-font text-2xl font-bold uppercase tracking-wider text-white mb-2">Belum Ada Jadwal</h3>
            <p class="text-sm text-white/50 max-w-md mx-auto leading-relaxed">
                Saat ini belum ada jadwal sesi latihan terdaftar untuk kelompok kelas anak Anda. Jadwal latihan berikutnya akan segera diupdate oleh tim kepelatihan.
            </p>
        </div>
    @endif
</div>
