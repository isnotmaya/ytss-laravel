...
<div class="space-y-10">
    ...
    <div>
        ...
        <p class="text-sm text-white/50 mt-1">
            Informasi detail mengenai kategori pembinaan kelompok umur anak Anda di YTSS Soccer School.
        </p>
    </div>
    ...
    @else
        ...
        <div class="text-center py-20 border border-dashed border-white/10 rounded-[32px] bg-white/[0.01]">
            ...
            <p class="text-sm text-white/50 max-w-md mx-auto leading-relaxed">
                Anak Anda belum terdaftar dalam kelompok kelas manapun. Silakan lengkapi pendaftaran anak Anda atau hubungi admin akademi.
            </p>
        </div>
    @endif
</div>
