    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
            ...
            <p class="text-sm text-white/50 mt-1">
                Daftar penghargaan, tropi, dan prestasi membanggakan yang diraih oleh kelompok kelas anak Anda.
            </p>
        </div>
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <p class="text-[10px] text-white/40 uppercase tracking-wider font-bold mt-1">
                                        {{ ($siswa && $siswa->kelompokKelas) ? $siswa->kelompokKelas->nama_kelompok : 'YTSS' }}
                                    </p>
                                </div>
                            </div>
    ...
    @else
        ...
        <div class="text-center py-20 border border-dashed border-white/10 rounded-[32px] bg-white/[0.01]">
            ...
            <p class="text-sm text-white/50 max-w-md mx-auto leading-relaxed">
                Saat ini belum ada data prestasi terdaftar untuk kelompok kelas anak Anda. Tetap berikan dukungan agar anak Anda terus berkembang!
            </p>
        </div>
    @endif
</div>
