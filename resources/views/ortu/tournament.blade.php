    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
            ...
            <p class="text-sm text-white/50 mt-1">
                Jadwal kompetisi, festival sepak bola, dan pertandingan liga yang diikuti kelompok kelas anak Anda.
            </p>
        </div>
    ...
    @else
        ...
        <div class="text-center py-20 border border-dashed border-white/10 rounded-[32px] bg-white/[0.01]">
            ...
            <p class="text-sm text-white/50 max-w-md mx-auto leading-relaxed">
                Saat ini belum ada agenda tournament terdaftar untuk kelompok kelas anak Anda. Tetap beri dukungan penuh untuk kompetisi mendatang!
            </p>
        </div>
    @endif
</div>
