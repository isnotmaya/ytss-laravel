    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
            ...
            <p class="text-sm text-white/50 mt-1">
                Jadwal sesi latihan rutin dan khusus untuk kelompok kelas Anda.
            </p>
        </div>
    ...
    @else
        ...
        <div class="text-center py-20 border border-dashed border-white/10 rounded-[32px] bg-white/[0.01]">
            ...
            <p class="text-sm text-white/50 max-w-md mx-auto leading-relaxed">
                Saat ini belum ada jadwal sesi latihan terdaftar untuk kelompok kelas Anda. Jadwal latihan berikutnya akan segera diupdate oleh tim kepelatihan.
            </p>
        </div>
    @endif
</div>
